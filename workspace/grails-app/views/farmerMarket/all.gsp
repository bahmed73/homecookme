...
<div>
			...
			<div id="centerBody" style="width:1000px;">
...
<div style="width: 1000px; margin-top: 0px;background-color: #fff;">
...
<g:if test="${session.profile==false}">
		...
		<!--<p style="margin-left: 97px;"><g:link url="${createLinkTo(dir:'images', file:'tip1.html')}" class="lbOn">Need Help?</g:link></p>-->
		 <div>
		 <div>
			<h2>Local featured farmers&#39; markets businesses</h2> 
			</div>
		 
		<br class="clear"/>
		<div class="update-separator-grey">&nbsp;</div>
		<g:render template="/common/all"/>
		</div>
		</div>
        </g:if>
