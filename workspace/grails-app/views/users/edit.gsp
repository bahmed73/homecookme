...
<meta http-equiv="window-target" content="_top" />
	...
	<title>Please come and share a recipe today.  What's cooking?</title>
...
<div style="float: left; width: 800px; padding: 20px 25px 20px 0px; ">
<br class="clear"/>
        <g:if test="${usersInstance.profilePhoto}">
        <img src="${usersInstance.profilePhoto}" width="48" height="48" class="profile_border">
        <br>
        </g:if>
