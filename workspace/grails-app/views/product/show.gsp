            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="product.userId.label" default="User Id" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: productInstance, field: "userId")}</td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="product.createTime.label" default="Create Time" /></td>
                            
                            <td valign="top" class="value"><g:formatDate date="${productInstance?.createTime}" /></td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="product.updateTime.label" default="Update Time" /></td>
                            
                            <td valign="top" class="value"><g:formatDate date="${productInstance?.updateTime}" /></td>
