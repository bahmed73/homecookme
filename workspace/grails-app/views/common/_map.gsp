    ...
    var YWSID = "R9OJqXa8h37Jf-QwVYTxNA"; // common required parameter (api key)
...
*/
    ...
    <div class="body">
        <div>Powered by <a href="http://www.yelp.com"><img src="http://static.px.yelp.com/i/map/miniMapLogo.png" border="0" /></a></div>
        <div>
            <form>
                Search for <input type="text" id="term" name="term" value="crocker galleria farmers market san francisco california"/> <input type="button" value="Search" onclick="return updateMap();"/>
